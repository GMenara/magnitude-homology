...
A $k$-path\giuliaBinline{In teoria dei grafi, in genere per path si intendono percorsi che non ripetono vertici. Quelli che usiamo qui si chiamerebbero trails. Visto che vogliamo mandare il lavoro a una conferenza di informatica, propongo di usare il termine trail. Altra proposta: numerare le tuple da 1 invece che da 0, così un k-path (o k-trail...) connette k nodi, ed è più intuitivo. Ci sono controindicazioni?} in a graph $G$ is a $(k+1)$-tuple $(x_0,\dots,x_k)$ of vertices  with $x_i \neq x_{i+1}$ and $d(x_i,x_{i+1})<\infty$ for every $i \leq k-1$.
...
\)\giuliaB{Mettere piccolo esempio in cui si vede che gli $x_i$ possono essere visitati anche più volte?}
We define the $(k,\ell)$-magnitude chain $MC_{k,\ell}(G)$ to be the free abelian group\giuliaB{Valutare se descriverlo come insieme e mettere footnote specificando che è un gruppo, così non ci perdiamo i revisori non matematici...?} generated by the $k$-paths of length $\ell$.
...
\]
\end{definition}
\giuliaBinline{Qualche osservazione su questo valore? Tipo, quando $a_i=0$...}
...
Therefore, $MC_{2,2}(G)$ is generated by the following $44$ elements: (0, 1, 0), (0, 1, 2), (0, 1, 3), (0, 2, 0), (0, 2, 1), (0, 2, 3), (0, 2, 4), (0, 3, 0), (0, 3, 1), (0, 3, 2), (1, 0, 1), (1, 0, 2), (1, 0, 3), (1, 2, 0), (1, 2, 1), (1, 2, 3), (1, 2, 4), (1, 3, 0), (1, 3, 1), (1, 3, 2), (2, 0, 1), (2, 0, 2), (2, 0, 3), (2, 1, 0), (2, 1, 2), (2, 1, 3), (2, 3, 0), (2, 3, 1), (2, 3, 2), (2, 4, 2), (3, 0, 1), (3, 0, 2), (3, 0, 3), (3, 1, 0), (3, 1, 2), (3, 1, 3), (3, 2, 0), (3, 2, 1), (3, 2, 3), (3, 2, 4), (4, 2, 0), (4, 2, 1), (4, 2, 3), (4, 2, 4).\giuliaBinline{Secondo me è un esempio troppo grosso. Si può scrivere l'insieme dei generatori in modo più sintetico, tipo: $\{(i,j,i)\mid i,j\in[0,4],i\neq j \}\cup\{(i,j,k)\mid i,j,k\in[0,3],i\neq j\neq k\}\cup \{(i,j,4)\mid i,j\in[0,3],i\neq j\}\cup\{(4,i,j)\mid i,j\in[0,3],i\neq j\}$ (controllare che sia corretto!)}
