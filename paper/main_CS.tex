...
A $k$-trail\giuliaB{Numerare le tuple da 1 invece che da 0, così un k-path (o k-trail...) connette k nodi, ed è più intuitivo. Ci sono controindicazioni?} in a graph $G$ is a $(k+1)$-tuple $(x_0,\dots,x_k)$ of vertices  with $x_i \neq x_{i+1}$ and $d(x_i,x_{i+1})<\infty$ for every $i \leq k-1$.
